...
const (
	bFile    = "/sys/class/backlight/gmux_backlight/brightness"
	maxBFile = "/sys/class/backlight/gmux_backlight/max_brightness"
)
...
func main() {
	...
	flag.Var(brightness, "brightness", "set brightness of display")
	flag.Var(inc, "inc", "increase brghtness of display by amt")
	flag.Var(dec, "dec", "decrease brightness of display by amt")
